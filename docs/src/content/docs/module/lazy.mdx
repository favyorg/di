...
export const lazyExample = `import { makeModule, type Live } from '@favy/di';
...
export const eagerExample = `import { makeModule, type Live } from '@favy/di';
...
<Editor client:load code={lazyExample} />
...
<Editor client:load code={eagerExample} />
